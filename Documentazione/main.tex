...
\begin{enumerate}
\item \textbf{Performance:} Migliore ricetta in base agli ingredienti forniti
\item \textbf{Enviroment:} L’ambiente nel quale il nostro agente opera è composto da tutte le ricette del dataset con i relativi: titolo, ingredienti, ratings, tempo di preparazione, istruzioni, tipologia.
 \end{enumerate}
L’ambiente risulta:
\begin{itemize}
